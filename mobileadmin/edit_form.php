							...
							<form action="update.php" method="post" class="form-horizontal" enctype="multipart/form-data">
								<div class="control-group">
									...
									<div class="controls">
										...
										<input type="text" class="span11" name="name" value="<?php echo $sp[0]['name'] ?>" />
									</div>
								</div>
								<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
											<select name="manu_id">
												<?php
												$manufacture = $db->getAllManufacture();
												foreach ($manufacture as $value) {
													if($value['manu_ID'] == $sp[0]['manu_ID']){
														?>				
										...
										<div class="control-group">
											...
											<div class="controls">
												<textarea class="span11" placeholder="Description" name = "description"><?php echo $sp[0]['description'] ?></textarea>
											</div>
											<div class="control-group">
												<label class="control-label">Price :</label>
												<div class="controls">
													<input value="<?php echo $sp[0]['price'] ?>" type="text" class="span11" placeholder="price" name = "price" /> *
												</div>
